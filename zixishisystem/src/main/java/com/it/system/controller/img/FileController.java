package com.it.system.controller.img;
...
public class FileController {
    ...
    public Result Adminupload(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        String value = "\\src\\main\\resources\\upload\\";
        String valueClass = "\\target\\classes\\upload\\";
        ...
        String str = "http://localhost:8081/" + "upload\\" + name + type;
